...
parrafo(
    "Subí el archivo “Planilla de Preguntas - FM.xlsx” (está en compartido/instrumentos/) a la "
    "carpeta Planillas."
)
aviso(
...
vineta("abrilo y compará contra 01-legacy-python/salidas/INFORME_FM.docx. Las tablas, los colores y los textos tienen que coincidir.", "El .docx en la carpeta Informes: ")
