"""Genera el informe de liderazgo para FM usando MODELO_DE_INFORME_1.docx como base.
Lee las respuestas directamente de 'Planilla de Preguntas - FM.xlsx' y
...
XLSX = "Planilla de Preguntas - FM 1.xlsx"
MODELO = "MODELO DE INFORME 2.docx"
OUTPUT = "INFORME_FM 1.docx"
RADAR_FILE = "grafico_radar_FM.png"
...
ax.plot(angles, ev, "o-", linewidth=2, color="#FF6600", label="FM")
...
ax.set_title("Coherencia Personalidad – Conductas de Liderazgo (FM)", y=1.08, fontsize=11)
plt.tight_layout()
...
add_p("El siguiente gráfico contrasta el perfil de FM con el perfil ideal de un Líder Situacional. Las zonas donde la línea del evaluado/a (naranja) se acerca al ideal (azul) representan fortalezas consolidadas; las zonas con mayor distancia indican brechas de desarrollo.", italic=True, size=10)
