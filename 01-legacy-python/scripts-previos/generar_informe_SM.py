"""Genera el informe de liderazgo para SM usando MODELO_DE_INFORME_1.docx como base.
Lee las respuestas directamente de 'Planilla de Preguntas - SM.xlsx' y
...
XLSX = "Planilla de Preguntas - SM.xlsx"
MODELO = "MODELO_DE_INFORME_1.docx"
OUTPUT = "INFORME_SM.docx"
RADAR_FILE = "grafico_radar_SM.png"
...
ax.plot(angles, ev, "o-", linewidth=2, color="#1E7B34", label="SM")
...
ax.set_title("Coherencia Personalidad – Conductas de Liderazgo (SM)", y=1.08, fontsize=11)
plt.tight_layout()
...
add_p("El siguiente gráfico contrasta el perfil de SM con el perfil ideal de un Líder Situacional. Las zonas donde la línea del evaluado/a (verde) se acerca al ideal (azul) representan fortalezas consolidadas; las zonas con mayor distancia indican brechas de desarrollo.", italic=True, size=10)
...
marco = [
    ...
    ("5. Resiliencia y Gestión del Cambio",
     ...
     f"El Neuroticismo Bajo (T={neo_t['N']}) es la base de la resiliencia personal: SM procesa las adversidades sin agotamiento emocional. Las Conductas de Cambio (P{con_p['Camb']}) confirman que ya opera como agente de transformación. El desarrollo de la comunicación Inspiracional es el catalizador que llevará este liderazgo transformacional al siguiente nivel de impacto organizacional."),
]
